        ...
        if heading:
            ...
            if level == 1 and first_h1:
                ...
                if level == 1:
                    ...
                    # Mantiene una separacion legible cuando la seccion abre directamente
                    # con un subtitulo, sin depender del colapso de espacios de Platypus.
...
def draw_page_background(canvas, doc):
    """Dibuja portada o chrome antes del contenido, segun el numero de pagina."""
