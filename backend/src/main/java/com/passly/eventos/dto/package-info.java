/**
 * Objetos de transferencia del componente: la unica forma en que los datos de Eventos cruzan
 * su frontera.
 *
 ...
 * {@code @NamedInterface}, {@code com.passly.eventos.dto} seria interno y el build fallaria el
 * dia que {@code ServicioDeVentas} importe {@code EventoDTO}.
 *
 * <p>Se declara desde el primer dia justamente para no descubrirlo mas adelante. A partir de
 * aca otro modulo puede declarar su dependencia como {@code "eventos :: dto"}.
 */
